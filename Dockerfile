...
RUN apt-get update 
RUN apt-get install -y --no-install-recommends openfoam11 make 
...
RUN curl -LOk https://github.com/demichie/OpenPDAC-11/archive/master.zip && unzip *.zip && rm master.zip
RUN /bin/bash -ic "/home/openfoam/OpenPDAC-11-main/applications/OpenPDAC/Allwmake"
RUN mkdir -p /home/openfoam/OpenFOAM/openfoam-11
